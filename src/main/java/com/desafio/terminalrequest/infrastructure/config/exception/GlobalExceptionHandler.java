...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNotFound(
        ...
        ResourceError errorBody = new ResourceError(status.value(), "Entity Not Found", ex.getMessage());
    ...
    protected ResponseEntity<Object> handleBadHeaders(
            IllegalStateException ex,
            WebRequest request) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        ResourceError errorBody = new ResourceError(status.value(), "The request is malformed", ex.getMessage() != null ? ex.getMessage() : "");
        ResponseEntity<Object> response = handleExceptionInternal(ex, errorBody, new HttpHeaders(), status, request);
        logger.error("{}", errorBody, ex);
        return response;
    }
    ...
    protected ResponseEntity<Object> handleIllegalArgumentError(
            ...
            WebRequest request) {
        HttpStatus status = HttpStatus.BAD_REQUEST;
        ResourceError errorBody = new ResourceError(status.value(), "The argument passed is invalid", ex.getMessage() != null ? ex.getMessage() : "");
        ResponseEntity<Object> response = handleExceptionInternal(ex, errorBody, new HttpHeaders(), status, request);
        logger.error("{}", errorBody, ex);
        return response;
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(
        ...
        ResourceError errorBody = new ResourceError(status.value(), "The argument passed is invalid", detail);
        ResponseEntity<Object> response = handleExceptionInternal(ex, errorBody, new HttpHeaders(), status, request);
        logger.error("{}", errorBody, ex);
        return response;
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        List<ResourceFieldError> fieldErrors = ex.getBindingResult().getFieldErrors().stream()
                .map(error -> new ResourceFieldError(
                        error.getField(),
                        error.getDefaultMessage() != null ? error.getDefaultMessage() : "invalid value",
                        error.getRejectedValue()))
                .collect(Collectors.toList());

        ResourceError errorBody = new ResourceError(
                status.value(),
                "Validation error",
                "One or more fields are invalid",
                fieldErrors
        );
        ResponseEntity<Object> response = handleExceptionInternal(ex, errorBody, headers, status, request);
        logger.error("{}", errorBody, ex);
        return response;
    }
